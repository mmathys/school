...
\chemfig{H-\lewis{26,O_1}-R'-\lewis{26,O_2}-H} Hydroxygruppe\\
...
\begin{definition}[Retrosynthese von Natriumpolyacrylat]\leavevmode \\
	...
	\chemfig{-[:30]-[:-30](-[:-90](=[:-30]O)-[:-150]O^\ominus)-[:30]-[:-30] \ +\ \ Na^\oplus} \ Natriumpolyacrylat\\
	
	\chemfig{=[:-30]-[:-90](-[:-150]O^\ominus)=[:-30]O \ + \ \ Na^\oplus} \ Natriumacrylat\\
